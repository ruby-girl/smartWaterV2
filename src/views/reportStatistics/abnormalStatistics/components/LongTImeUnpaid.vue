    ...
    <div class="contanier">
      ...
      <div class="main-padding-20-y" id="table">
        ...
        >
          ...
          <el-table-column prop="name" label="身份证" width="180"></el-table-column>
          ...
          <el-table-column prop="name" label="最后缴费日期" width="180"></el-table-column>
          <el-table-column prop="name" label="未缴费天数" width="180"></el-table-column>
          <el-table-column prop="name" label="欠费笔数" width="180"></el-table-column>
          <el-table-column prop="name" label="历史充值金额" width="180"></el-table-column>
          <el-table-column prop="name" label="账户余额" width="180"></el-table-column>
