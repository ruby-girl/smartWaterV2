<template>
  <div>
    <div class="user_information">
      ...
      <el-form :inline="true" ref="ycData" :model="ycData" :rules="rules" label-width="100px">
        <el-form-item label="水厂：" prop="SA_WaterFactory_Id">
          <el-select v-model="ycData.SA_WaterFactory_Id" placeholder="请选择" size="small">
        ...
        <el-form-item label="姓名：" prop="CustomerName">
          <el-input v-model.trim="ycData.CustomerName" placeholder="长度（1-30）" max-length="30" size="small"/>
        </el-form-item>
        <el-form-item label="简码：" prop="NameCode">
          <el-input :disabled="true" v-model="ycData.NameCode" size="small"/>
        </el-form-item>
        <el-form-item label="电话：">
          <el-input v-model.number="ycData.Tel " size="small"/>
        </el-form-item>
        ...
        <el-form-item label="表册：" v-show="differ">
    ...
    <div class="user_information">
      ...
      <el-form :inline="true" ref="ruleForm" :model="ycData" :rules="rules" label-width="100px">
        <!--远程水表 s-->
        <el-form-item label="水表编号：" prop="WaterMeterNo" v-show="!differ">
          <el-input v-model.trim="ycData.WaterMeterNo " size="small" placeholder="【按enter建查询水表信息】"/>
        </el-form-item>
        <el-form-item label="集中器号：" v-show="!differ">
          <el-input :disabled="true" v-model="waterInfo.ConcentratorNo" size="small"/>
        </el-form-item>
        <el-form-item label="采集器号：" v-show="!differ">
          <el-input :disabled="true" v-model="waterInfo.CollectorNo" size="small"/>
        </el-form-item>
        <el-form-item label="报警金额：" prop="AlarmMoney" v-show="!differ">
          <el-input :disabled="true" v-model.trim="ycData.AlarmMoney " size="small"/>
        </el-form-item>
        <el-form-item label="透支金额：" prop="OverdraftMoney" v-show="!differ">
          <el-input :disabled="true" v-model.trim="ycData.OverdraftMoney " size="small"/>
        </el-form-item>
        <!--远程水表 e-->
        <!--物联网 s -->
        ...
        <el-form-item label="报警量：" prop="AlarmYield" v-show="differ">
          <el-input size="small" v-model.trim="ycData.AlarmYield"/>
        </el-form-item>
        <el-form-item label="透支量：" prop="OverdraftYield" v-show="differ">
          <el-input  size="small" v-model.trim="ycData.OverdraftYield"/>
        </el-form-item>
        <!--远传网 不需存s-->
        <el-form-item label="当前读数：" v-show="!differ">
