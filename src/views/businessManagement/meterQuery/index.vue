    ...
    <div>
        <div id="conditionBox">
          ...
          <div class="cl-operation1 clearfix">
            <el-button type="primary" size="small" class="fr cl-color1" @click="setCustomData()" style="margin-left: 10px;"><i class="icon iconfont">&#xe678;</i> 表格自定义</el-button>
        ...
        <!--自定义组建 e-->
        <!--列表组建 s-->
        <el-table id="table" :data="tableData" :height="tableHeight"  border
                  @sort-change="sortChanges" ref="multipleTable">
          <el-table-column
            type="index"
            label="序号"
            width="80"
