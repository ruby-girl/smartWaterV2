  ...
  >
    <el-form-item label="水厂" v-if="this.waterWorks.length>1">
      <el-select
        ...
        @change="getText(selectHead.SA_WaterFactory_Id,'SA_WaterFactory_Id',waterWorks)"
      >
    ...
    <el-form-item label="用户类型">
      <el-select
        ...
        placeholder="请选择"
        @keydown.enter.native="handleFilter"
        @change="getText(selectHead.UserType,'UserType',userType)"
      >
        <el-option label="全部" value="-1" />
    ...
    <el-form-item label="换表操作员">
      <el-select
        ...
        placeholder="请选择"
        @keydown.enter.native="handleFilter"
        @change="getText(selectHead.OpId,'OpId',editUserList)"
      >
        <el-option label="全部" value="-1" />
    ...
    <el-form-item label="换表类型">
      <el-select
        ...
        placeholder="请选择"
        @keydown.enter.native="handleFilter"
        @change="getText(selectHead.OpId,'OpId',changeType)"
      >
        <el-option label="全部" value="-1" />
...
export default {
  ...
  data() {
    return {
      ...
      userType: [],
      waterWorks: [], //水厂
      changeType: [{ Name: "以旧换新", Id: "1" }, { Name: "用户互换", Id: "2" }]
    };
  },
  created() {
