<template>
  <div class="mac-contianer">
    ...
    <div class="cl-operation1 clearfix">
      <el-button type="success" size="small" class="fl" style="background:rgba(51,179,0,1);border-color:rgba(51,179,0,1)">
        <i class="icon iconfont" style="font-size:12px">&#xe642;</i> 抄表
      </el-button>
      <el-button type="success" size="small" class="fl" style="background:rgba(0,178,161,1);border-color:rgba(0,178,161,1)">
        <i class="icon iconfont" style="font-size:12px">&#xe646;</i> 阀门锁定开
      </el-button>
      <el-button type="success" size="small" class="fl" style="background:rgba(229,169,3,1);border-color:rgba(229,169,3,1)">
        <i class="icon iconfont" style="font-size:12px">&#xe643;</i> 阀门锁定关
      </el-button>
      <el-button type="success" size="small" class="fl" style="background:rgba(117,194,0,1);border-color:rgba(117,194,0,1)">
