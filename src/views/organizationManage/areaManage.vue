  ...
  <div class="cl-container">
      ...
      <div id="conditionBox">
        ...
        >
          <el-form-item label="片区：">
            <el-input v-model="dp.DeptName" maxlength="20" placeholder="片区名称(长度20)" @keyup.enter.native="handleFilter" />
          </el-form-item>
    ...
    >
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px" class="demo-ruleForm">
        <el-form-item label="片区:" prop="newDertmentName">
          <el-input
        ...
        <el-form-item label="水厂:" prop="newDertmentName">
          <el-select  style="width: 250px" multiple v-model="veshi">
               <el-option label="全部" value="-1"></el-option>
               <el-option v-for="(item,index) in operatorArray" :key="index" :label="item.Name" :value="item.Id" />
          </el-select>
        </el-form-item>
